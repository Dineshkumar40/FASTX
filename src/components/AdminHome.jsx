...
const AdminHome = () => {
    ...
    return (
        <>
            <Anavbar />
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20 p-6 mt-10 mb-16 max-w-5xl mx-auto ">
                {/* {/View Booking/} */}
                <div className="bg-gray-100 cursor-pointer text-red-600 p-6 rounded-2xl shadow-md text-center w-10/12 mx-auto transform transition duration-300 hover:scale-105 hover:bg-gray-200 hover:shadow-lg hover:py-4" >
                    ...
                    {/* {/Click here/} */}
                    <div onClick={() => navigate("/Aviewseats")} className="flex items-center justify-center space-x-2 text-black opacity-50 hover:opacity-100">
